...
class LogsApi (
     ...
     * @return LogResponse
     */
    suspend fun getLogById(id: kotlin.String, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): LogResponse? {
        val body: Any? = null
        ...
        val path = "/logs/{id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<LogResponse> { response ->
            ...
            val responseType = object : TypeToken<LogResponse>() {}.type
            ...
            val request: Request<LogResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     * @return LogsResponse
     */
    suspend fun getLogs(acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null, limit: kotlin.Int? = 20, search: kotlin.String? = null, next: kotlin.String? = null, previous: kotlin.String? = null): LogsResponse? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<LogsResponse> { response ->
                continuation.resume(response)
            }
            ...
            val responseType = object : TypeToken<LogsResponse>() {}.type

            // Call the correct request builder based on whether we have a return type or a body.
            // All other switching on types must be done in code inside the builder
            val request: Request<LogsResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
