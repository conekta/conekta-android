...
class TokensApi (
     ...
     */
    suspend fun createToken(token: Token, acceptLanguage: kotlin.String? = "es"): TokenResponse? {
        val body: Any? = token
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<TokenResponse> { response ->
            ...
            val responseType = object : TypeToken<TokenResponse>() {}.type
            ...
            val request: Request<TokenResponse> = requestFactory.build(
                    Request.Method.POST,
                    "$basePath$path",
                    body,
                    headerParams,
