...
public class GetWebhooksResponse  {
  ...
  @SerializedName("data")
  private List<WebhookResponse> data = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.hasMore == null ? getWebhooksResponse.hasMore == null : this.hasMore.equals(getWebhooksResponse.hasMore)) &&
        (this._object == null ? getWebhooksResponse._object == null : this._object.equals(getWebhooksResponse._object)) &&
        (this.nextPageUrl == null ? getWebhooksResponse.nextPageUrl == null : this.nextPageUrl.equals(getWebhooksResponse.nextPageUrl)) &&
        (this.previousPageUrl == null ? getWebhooksResponse.previousPageUrl == null : this.previousPageUrl.equals(getWebhooksResponse.previousPageUrl)) &&
        (this.data == null ? getWebhooksResponse.data == null : this.data.equals(getWebhooksResponse.data));
  }
