...
public class ProductDataResponse  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.antifraudInfo == null ? productDataResponse.antifraudInfo == null : this.antifraudInfo.equals(productDataResponse.antifraudInfo)) &&
        (this.brand == null ? productDataResponse.brand == null : this.brand.equals(productDataResponse.brand)) &&
        (this.description == null ? productDataResponse.description == null : this.description.equals(productDataResponse.description)) &&
        (this.metadata == null ? productDataResponse.metadata == null : this.metadata.equals(productDataResponse.metadata)) &&
        (this.name == null ? productDataResponse.name == null : this.name.equals(productDataResponse.name)) &&
        (this.quantity == null ? productDataResponse.quantity == null : this.quantity.equals(productDataResponse.quantity)) &&
        (this.sku == null ? productDataResponse.sku == null : this.sku.equals(productDataResponse.sku)) &&
        (this.tags == null ? productDataResponse.tags == null : this.tags.equals(productDataResponse.tags)) &&
        (this.unitPrice == null ? productDataResponse.unitPrice == null : this.unitPrice.equals(productDataResponse.unitPrice)) &&
        (this.id == null ? productDataResponse.id == null : this.id.equals(productDataResponse.id)) &&
        (this._object == null ? productDataResponse._object == null : this._object.equals(productDataResponse._object)) &&
        (this.parentId == null ? productDataResponse.parentId == null : this.parentId.equals(productDataResponse.parentId));
  }
