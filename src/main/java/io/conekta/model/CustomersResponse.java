...
public class CustomersResponse  {
  ...
  @SerializedName("data")
  private List<CustomerResponse> data = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.hasMore == null ? customersResponse.hasMore == null : this.hasMore.equals(customersResponse.hasMore)) &&
        (this._object == null ? customersResponse._object == null : this._object.equals(customersResponse._object)) &&
        (this.nextPageUrl == null ? customersResponse.nextPageUrl == null : this.nextPageUrl.equals(customersResponse.nextPageUrl)) &&
        (this.previousPageUrl == null ? customersResponse.previousPageUrl == null : this.previousPageUrl.equals(customersResponse.previousPageUrl)) &&
        (this.data == null ? customersResponse.data == null : this.data.equals(customersResponse.data));
  }
