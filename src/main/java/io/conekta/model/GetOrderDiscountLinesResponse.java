...
public class GetOrderDiscountLinesResponse  {
  ...
  @SerializedName("data")
  private List<DiscountLinesResponse> data = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.hasMore == null ? getOrderDiscountLinesResponse.hasMore == null : this.hasMore.equals(getOrderDiscountLinesResponse.hasMore)) &&
        (this._object == null ? getOrderDiscountLinesResponse._object == null : this._object.equals(getOrderDiscountLinesResponse._object)) &&
        (this.nextPageUrl == null ? getOrderDiscountLinesResponse.nextPageUrl == null : this.nextPageUrl.equals(getOrderDiscountLinesResponse.nextPageUrl)) &&
        (this.previousPageUrl == null ? getOrderDiscountLinesResponse.previousPageUrl == null : this.previousPageUrl.equals(getOrderDiscountLinesResponse.previousPageUrl)) &&
        (this.data == null ? getOrderDiscountLinesResponse.data == null : this.data.equals(getOrderDiscountLinesResponse.data));
  }
