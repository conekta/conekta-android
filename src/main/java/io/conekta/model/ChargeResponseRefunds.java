...
public class ChargeResponseRefunds  {
  ...
  @SerializedName("data")
  private List<ChargeResponseRefundsData> data = null;
   ...
   * refunds
   **/
  @ApiModelProperty(value = "refunds")
  ...
  public boolean equals(Object o) {
    ...
    return (this.hasMore == null ? chargeResponseRefunds.hasMore == null : this.hasMore.equals(chargeResponseRefunds.hasMore)) &&
        (this._object == null ? chargeResponseRefunds._object == null : this._object.equals(chargeResponseRefunds._object)) &&
        (this.nextPageUrl == null ? chargeResponseRefunds.nextPageUrl == null : this.nextPageUrl.equals(chargeResponseRefunds.nextPageUrl)) &&
        (this.previousPageUrl == null ? chargeResponseRefunds.previousPageUrl == null : this.previousPageUrl.equals(chargeResponseRefunds.previousPageUrl)) &&
        (this.data == null ? chargeResponseRefunds.data == null : this.data.equals(chargeResponseRefunds.data));
  }
