...
import io.conekta.auth.Authentication;
import io.conekta.auth.ApiKeyAuth;
import io.conekta.auth.HttpBasicAuth;
import io.conekta.request.GetRequest;
import io.conekta.request.PostRequest;
import io.conekta.request.PutRequest;
import io.conekta.request.DeleteRequest;
import io.conekta.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("Conekta/v2 JavaBindings/6.0.0-beta");
  ...
  public Request<String> createRequest(String host, String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames, Response.Listener<String> stringRequest, Response.ErrorListener errorListener) throws ApiException, UnsupportedEncodingException {
    ...
    headers.put("Accept", "application/vnd.conekta-v2.1.0+json");
