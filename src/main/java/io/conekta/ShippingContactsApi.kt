...
class ShippingContactsApi (
     ...
     */
    suspend fun createCustomerShippingContacts(id: kotlin.String, customerShippingContacts: CustomerShippingContacts, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): CustomerShippingContactsResponse? {
        val body: Any? = customerShippingContacts
        ...
        val path = "/customers/{id}/shipping_contacts".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<CustomerShippingContactsResponse> { response ->
            ...
            val responseType = object : TypeToken<CustomerShippingContactsResponse>() {}.type
            ...
            val request: Request<CustomerShippingContactsResponse> = requestFactory.build(
                    Request.Method.POST,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     * @return CustomerShippingContactsResponse
     */
    suspend fun deleteCustomerShippingContacts(id: kotlin.String, shippingContactsId: kotlin.String, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): CustomerShippingContactsResponse? {
        val body: Any? = null
        ...
        // create path and map variables
        val path = "/customers/{id}/shipping_contacts/{shipping_contacts_id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString())).replace("{" + "shipping_contacts_id" + "}", IRequestFactory.escapeString(shippingContactsId.toString()))
     ...
     * @return CustomerShippingContactsResponse
     */
    suspend fun updateCustomerShippingContacts(id: kotlin.String, shippingContactsId: kotlin.String, customerUpdateShippingContacts: CustomerUpdateShippingContacts, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): CustomerShippingContactsResponse? {
        val body: Any? = customerUpdateShippingContacts
