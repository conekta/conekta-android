...
class TaxesApi (
     ...
     */
    suspend fun ordersCreateTaxes(id: kotlin.String, orderTaxRequest: OrderTaxRequest, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): UpdateOrderTaxResponse? {
        val body: Any? = orderTaxRequest
        ...
        val path = "/orders/{id}/tax_lines".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<UpdateOrderTaxResponse> { response ->
            ...
            val responseType = object : TypeToken<UpdateOrderTaxResponse>() {}.type
            ...
            val request: Request<UpdateOrderTaxResponse> = requestFactory.build(
                    Request.Method.POST,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     * @return UpdateOrderTaxResponse
     */
    suspend fun ordersDeleteTaxes(id: kotlin.String, taxId: kotlin.String, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): UpdateOrderTaxResponse? {
        val body: Any? = null
        ...
        // create path and map variables
        val path = "/orders/{id}/tax_lines/{tax_id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString())).replace("{" + "tax_id" + "}", IRequestFactory.escapeString(taxId.toString()))
     ...
     * @return UpdateOrderTaxResponse
     */
    suspend fun ordersUpdateTaxes(id: kotlin.String, taxId: kotlin.String, updateOrderTaxRequest: UpdateOrderTaxRequest, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): UpdateOrderTaxResponse? {
        val body: Any? = updateOrderTaxRequest
