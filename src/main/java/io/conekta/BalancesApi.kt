...
class BalancesApi (
     ...
     */
    suspend fun getBalance(acceptLanguage: kotlin.String? = "es"): BalanceResponse? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<BalanceResponse> { response ->
            ...
            val responseType = object : TypeToken<BalanceResponse>() {}.type
            ...
            val request: Request<BalanceResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
