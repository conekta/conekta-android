...
class ShippingsApi (
     ...
     */
    suspend fun ordersCreateShipping(id: kotlin.String, shippingRequest: ShippingRequest, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): ShippingOrderResponse? {
        val body: Any? = shippingRequest
        ...
        val path = "/orders/{id}/shipping_lines".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<ShippingOrderResponse> { response ->
            ...
            val responseType = object : TypeToken<ShippingOrderResponse>() {}.type
            ...
            val request: Request<ShippingOrderResponse> = requestFactory.build(
                    Request.Method.POST,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     * @return ShippingOrderResponse
     */
    suspend fun ordersDeleteShipping(id: kotlin.String, shippingId: kotlin.String, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): ShippingOrderResponse? {
        val body: Any? = null
        ...
        // create path and map variables
        val path = "/orders/{id}/shipping_lines/{shipping_id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString())).replace("{" + "shipping_id" + "}", IRequestFactory.escapeString(shippingId.toString()))
     ...
     * @return ShippingOrderResponse
     */
    suspend fun ordersUpdateShipping(id: kotlin.String, shippingId: kotlin.String, shippingRequest: ShippingRequest, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): ShippingOrderResponse? {
        val body: Any? = shippingRequest
