...
class PayoutOrdersApi (
     ...
     */
    suspend fun createPayoutOrder(payoutOrder: PayoutOrder, acceptLanguage: kotlin.String? = "es"): PayoutOrderResponse? {
        val body: Any? = payoutOrder
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<PayoutOrderResponse> { response ->
            ...
            val responseType = object : TypeToken<PayoutOrderResponse>() {}.type
            ...
            val request: Request<PayoutOrderResponse> = requestFactory.build(
                    Request.Method.POST,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     * @return PayoutOrderResponse
     */
    suspend fun getPayoutOrderById(id: kotlin.String, acceptLanguage: kotlin.String? = "es"): PayoutOrderResponse? {
        val body: Any? = null
        ...
        // create path and map variables
        val path = "/payout_orders/{id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
     ...
     */
    suspend fun getPayoutOrders(acceptLanguage: kotlin.String? = "es", limit: kotlin.Int? = 20, search: kotlin.String? = null, next: kotlin.String? = null, previous: kotlin.String? = null): PayoutOrdersResponse? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<PayoutOrdersResponse> { response ->
                continuation.resume(response)
            }
            ...
            val responseType = object : TypeToken<PayoutOrdersResponse>() {}.type

            // Call the correct request builder based on whether we have a return type or a body.
            // All other switching on types must be done in code inside the builder
            val request: Request<PayoutOrdersResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
