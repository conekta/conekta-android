...
class CompaniesApi (
     ...
     */
    suspend fun getCompanies(acceptLanguage: kotlin.String? = "es", limit: kotlin.Int? = 20, search: kotlin.String? = null, next: kotlin.String? = null, previous: kotlin.String? = null): GetCompaniesResponse? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<GetCompaniesResponse> { response ->
            ...
            val responseType = object : TypeToken<GetCompaniesResponse>() {}.type
            ...
            val request: Request<GetCompaniesResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     */
    suspend fun getCompany(id: kotlin.String, acceptLanguage: kotlin.String? = "es"): CompanyResponse? {
        val body: Any? = null
        ...
        // create path and map variables
        val path = "/companies/{id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<CompanyResponse> { response ->
                continuation.resume(response)
            }
            ...
            val responseType = object : TypeToken<CompanyResponse>() {}.type

            // Call the correct request builder based on whether we have a return type or a body.
            // All other switching on types must be done in code inside the builder
            val request: Request<CompanyResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
