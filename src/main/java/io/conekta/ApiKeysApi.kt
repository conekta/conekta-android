...
class ApiKeysApi (
     ...
     */
    suspend fun createApiKey(apiKeyRequest: ApiKeyRequest, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): ApiKeyCreateResponse? {
        val body: Any? = apiKeyRequest
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<ApiKeyCreateResponse> { response ->
            ...
            val responseType = object : TypeToken<ApiKeyCreateResponse>() {}.type
            ...
            val request: Request<ApiKeyCreateResponse> = requestFactory.build(
                    Request.Method.POST,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     */
    suspend fun deleteApiKey(id: kotlin.String, acceptLanguage: kotlin.String? = "es"): DeleteApiKeysResponse? {
        val body: Any? = null
        ...
        // create path and map variables
        val path = "/api_keys/{id}".replace("{" + "id" + "}", IRequestFactory.escapeString(id.toString()))
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<DeleteApiKeysResponse> { response ->
                continuation.resume(response)
            }
            ...
            val responseType = object : TypeToken<DeleteApiKeysResponse>() {}.type

            // Call the correct request builder based on whether we have a return type or a body.
            // All other switching on types must be done in code inside the builder
            val request: Request<DeleteApiKeysResponse> = requestFactory.build(
     ...
     */
    suspend fun getApiKey(id: kotlin.String, acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null): ApiKeyResponse? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<ApiKeyResponse> { response ->
                continuation.resume(response)
            }
            ...
            val responseType = object : TypeToken<ApiKeyResponse>() {}.type

            // Call the correct request builder based on whether we have a return type or a body.
            // All other switching on types must be done in code inside the builder
            val request: Request<ApiKeyResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     */
    suspend fun getApiKeys(acceptLanguage: kotlin.String? = "es", xChildCompanyId: kotlin.String? = null, limit: kotlin.Int? = 20, next: kotlin.String? = null, previous: kotlin.String? = null, search: kotlin.String? = null): GetApiKeysResponse? {
        val body: Any? = null
        ...
        return suspendCoroutine { continuation ->
            val responseListener = Response.Listener<GetApiKeysResponse> { response ->
                continuation.resume(response)
            }
            ...
            val responseType = object : TypeToken<GetApiKeysResponse>() {}.type

            // Call the correct request builder based on whether we have a return type or a body.
            // All other switching on types must be done in code inside the builder
            val request: Request<GetApiKeysResponse> = requestFactory.build(
                    Request.Method.GET,
                    "$basePath$path",
                    body,
                    headerParams,
     ...
     * @return ApiKeyResponse
     */
    suspend fun updateApiKey(id: kotlin.String, acceptLanguage: kotlin.String? = "es", apiKeyUpdateRequest: ApiKeyUpdateRequest? = null): ApiKeyResponse? {
        val body: Any? = apiKeyUpdateRequest
