...
class CustomerResponseShippingContactsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CustomerResponseShippingContacts
        //val modelInstance = CustomerResponseShippingContacts()
