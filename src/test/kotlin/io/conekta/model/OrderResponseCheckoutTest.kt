...
class OrderResponseCheckoutTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of OrderResponseCheckout
        //val modelInstance = OrderResponseCheckout()
        ...
        // to test the property `isRedirectOnFailure`
        should("test isRedirectOnFailure") {
            // uncomment below to test the property
            //modelInstance.isRedirectOnFailure shouldBe ("TODO")
        }
