...
class OrderResponseShippingContactTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of OrderResponseShippingContact
        //val modelInstance = OrderResponseShippingContact()
