...
class ChargeOrderResponsePaymentMethodTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ChargeOrderResponsePaymentMethod
        //val modelInstance = ChargeOrderResponsePaymentMethod()
