...
class GetTransfersResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetTransfersResponse
        //val modelInstance = GetTransfersResponse()
        ...
        // to test the property ``data`` - Transfers
        should("test `data`") {
            // uncomment below to test the property
