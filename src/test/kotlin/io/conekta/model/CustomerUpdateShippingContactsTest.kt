...
class CustomerUpdateShippingContactsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CustomerUpdateShippingContacts
        //val modelInstance = CustomerUpdateShippingContacts()
