...
class GetCustomerPaymentMethodDataResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetCustomerPaymentMethodDataResponse
        //val modelInstance = GetCustomerPaymentMethodDataResponse()
