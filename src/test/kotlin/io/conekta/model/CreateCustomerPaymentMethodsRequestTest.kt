...
class CreateCustomerPaymentMethodsRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateCustomerPaymentMethodsRequest
        //val modelInstance = CreateCustomerPaymentMethodsRequest()
