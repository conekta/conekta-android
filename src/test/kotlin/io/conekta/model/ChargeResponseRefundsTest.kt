...
class ChargeResponseRefundsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ChargeResponseRefunds
        //val modelInstance = ChargeResponseRefunds()
        ...
        // to test the property ``data`` - refunds
        should("test `data`") {
            // uncomment below to test the property
