...
class UpdateCustomerPaymentMethodsResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UpdateCustomerPaymentMethodsResponse
        //val modelInstance = UpdateCustomerPaymentMethodsResponse()
