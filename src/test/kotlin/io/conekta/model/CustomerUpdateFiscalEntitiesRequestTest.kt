...
class CustomerUpdateFiscalEntitiesRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CustomerUpdateFiscalEntitiesRequest
        //val modelInstance = CustomerUpdateFiscalEntitiesRequest()
