...
class OrderRequestCustomerInfoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of OrderRequestCustomerInfo
        //val modelInstance = OrderRequestCustomerInfo()
