...
class CheckoutOrderTemplateCustomerInfoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CheckoutOrderTemplateCustomerInfo
        //val modelInstance = CheckoutOrderTemplateCustomerInfo()
