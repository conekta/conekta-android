...
class CustomerShippingContactsDataResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CustomerShippingContactsDataResponse
        //val modelInstance = CustomerShippingContactsDataResponse()
