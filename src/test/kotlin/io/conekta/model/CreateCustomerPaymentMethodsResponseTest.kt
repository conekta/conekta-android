...
class CreateCustomerPaymentMethodsResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateCustomerPaymentMethodsResponse
        //val modelInstance = CreateCustomerPaymentMethodsResponse()
