...
class UpdateCustomerFiscalEntitiesResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UpdateCustomerFiscalEntitiesResponse
        //val modelInstance = UpdateCustomerFiscalEntitiesResponse()
