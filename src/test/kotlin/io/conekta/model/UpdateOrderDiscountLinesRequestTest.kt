...
class UpdateOrderDiscountLinesRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UpdateOrderDiscountLinesRequest
        //val modelInstance = UpdateOrderDiscountLinesRequest()
