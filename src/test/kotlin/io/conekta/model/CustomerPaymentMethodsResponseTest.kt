...
class CustomerPaymentMethodsResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CustomerPaymentMethodsResponse
        //val modelInstance = CustomerPaymentMethodsResponse()
