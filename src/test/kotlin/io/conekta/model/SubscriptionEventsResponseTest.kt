...
class SubscriptionEventsResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SubscriptionEventsResponse
        //val modelInstance = SubscriptionEventsResponse()
