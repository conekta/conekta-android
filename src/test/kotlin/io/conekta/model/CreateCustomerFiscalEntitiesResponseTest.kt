...
class CreateCustomerFiscalEntitiesResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateCustomerFiscalEntitiesResponse
        //val modelInstance = CreateCustomerFiscalEntitiesResponse()
