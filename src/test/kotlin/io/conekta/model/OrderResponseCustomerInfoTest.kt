...
class OrderResponseCustomerInfoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of OrderResponseCustomerInfo
        //val modelInstance = OrderResponseCustomerInfo()
