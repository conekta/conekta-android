...
class OrderResponseDiscountLinesTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of OrderResponseDiscountLines
        //val modelInstance = OrderResponseDiscountLines()
