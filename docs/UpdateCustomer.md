...
**email** | **kotlin.String** | An email address is a series of customizable characters followed by a universal Internet symbol, the at symbol (@), the name of a host server, and a web domain ending (.mx, .com, .org, . net, etc). |  [optional]
**name** | **kotlin.String** | Client&#39;s name |  [optional]
**phone** | **kotlin.String** | Is the customer&#39;s phone number |  [optional]
